...
int dns_init(dns_t *dns, const char *dns_ip);
int dns_request(dns_t *dns, const char *name);
int dns_receive(dns_t *dns);
int dns_set_timeout(dns_t *dns, int seconds);
void dns_close(dns_t *dns);
